...
class Sam3Master2Node(Node):
    def __init__(self):
        super().__init__('sam3_l_master2_node')

        # ---------------- master control ----------------
        self.declare_parameter('start_topic', '/sam3_l_start')
        self.declare_parameter('prompt_topic', '/sam3_l_text_prompt')
        self.declare_parameter('finish_topic', '/sam3_l_finish')
        ...
        self.declare_parameter('color_compressed_topic', '/camera_l/camera_l/color/image_rect_raw/compressed')
        self.declare_parameter('depth_topic', '/camera_l/camera_l/aligned_depth_to_color/image_raw')
        self.declare_parameter('depth_compressed_topic', '/camera_l/camera_l/aligned_depth_to_color/image_raw/compressedDepth')
        self.declare_parameter('camera_info_topic', '/camera_l/camera_l/aligned_depth_to_color/camera_info')
        self.declare_parameter('fallback_camera_info_topic', '/sam3_l/camera_info_fallback')
        self.declare_parameter('local_camera_info_cache_yaml', '~/colcon_ws/src/master_capstone/config/camera_l_aligned.yaml')

        # ---------------- Prompt / outputs ----------------
        self.declare_parameter('prompt', 'target object')
        self.declare_parameter('save_dir', '/home/jwg/sam3_ros_output_l')
