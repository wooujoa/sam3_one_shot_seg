...
class Sam3OneShotNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('sam3_one_shot_node ready.')
    ...
    def run_pipeline(self, color_msg: RosImage, depth_msg: RosImage, camera_info: CameraInfo):
        ...
        self.get_logger().info(
            f'Start repeated publish: {self.publish_remaining} times, period={self.publish_repeat_period_sec:.2f}s'
        )
    ...
    def publish_once_bundle(self):
        ...
        self.get_logger().info(f'Published target/object/background/center. remaining={self.publish_remaining}')
